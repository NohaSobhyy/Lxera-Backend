...
class SaleController extends Controller
{
    ...
    public function toggleAccess($saleId, Request $request)
    {
        ...
        if ($sale) {
           ...
           // \Log::info('Toggling access for sale ID: ' . $saleId . ' with status: ' . $request->access_to_purchased_item);
    
            // Update the access status
            $sale->access_to_purchased_item = $request->access_to_purchased_item;
            $sale->save();
    
            return response()->json(['success' => true]);
        }
    
        // Log error if sale is not found
      //  \Log::error('Sale not found for ID: ' . $saleId);
