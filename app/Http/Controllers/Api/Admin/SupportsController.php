...
class SupportsController extends Controller
{
    ...
    private function getStatusEnumFromTranslation($translatedStatus)
    {

        $translatedStatus = trim($translatedStatus);

        $map = [
            trans('panel.open') => 'open',
            trans('panel.close') => 'close',
            trans('panel.replied') => 'replied',
            trans('panel.supporter_replied') => 'supporter_replied',
        ];

        return $map[$translatedStatus] ?? null;
    }
