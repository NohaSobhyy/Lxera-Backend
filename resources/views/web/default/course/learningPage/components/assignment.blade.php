                    ...
                    @if($user->id == $assignment->creator_id || $user->isTeacher() )
                        <div class="bg-info-light p-10 rounded-sm border mt-15">
                            ...
                            <form method="post" action="/course/assignment/{{ $assignment->id }}/history/{{ $assignmentHistory->id }}/setGrade">
                                ...
                                <div class="form-group">
                                    <label class="input-label">اكتب تعليق</label>
                                    <textarea name="comment" class="form-control" rows="4" placeholder="اكتب تعليق"></textarea>
                                    <div class="invalid-feedback"></div>
                                </div>
                ...
                <div class="h-100">
                    ...
                    @foreach($assignmentHistory->messages as $message)
                        <div class="assignment-attachments-post p-15 border rounded-sm mb-15">
                            ...
                            @if(!empty($assignmentHistory->comment))
                                <div class="mt-15 font-14 text-dark-blue">
                                    <strong>تعليق المعلم : </strong>
                                    <p>{{ $assignmentHistory->comment }}</p>
                                </div>
                            @endif
