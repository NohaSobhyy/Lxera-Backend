                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="form-group col-12 col-sm-6" id="anotherEducationCountrySection"
                                        ...
                                        <input type="text" id="anotherEducationCountry"
                                            ...
                                            placeholder="{{trans('public.enter_bachelor_certificate_source')}}"
                                    ...
                                    <div class="form-group col-12 col-sm-6 high_education">
                                        <label for="education_specialization" class="form-label">
                                            {{trans('public.specialization')}}<span class="text-danger">*</span>
                                        </label>
                                        <input type="text" id="education_specialization"
                                            class="form-control @error('education_specialization') is-invalid @enderror"
                                            name="education_specialization" placeholder="{{trans('public.specialization')}}"
                                    ...
                                    <div class="form-group col-12 col-sm-6 high_education">
                                        ...
                                        <input type="text" id="graduation_year"
                                            ...
                                            name="graduation_year" placeholder="{{trans('public.graduation_year')}}"
                                    ...
                                    <div class="form-group col-12 col-sm-6 high_education">
                                        <label for="gpa" class="form-label">
                                           {{trans('public.average')}}<span class="text-danger">*</span>
                                        </label>
                                    ...
                                    <div class="col-12 row high_education">
                                        ...
                                        <div class="form-group col-12 col-sm-6 high_education">
                                            <div>
                                                <label for="high_certificate_img">{{trans('public.graduation_certificate_picture')}}</label>
                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="form-group col-12 col-sm-6">
                                        <label for="educational_qualification_country"
                                            ...
                                            {{trans('public.secondary_certificate_source_country')}}
                                        ...
                                        <select id="secondary_educational_qualification_country"
                                            ...
                                            <option value="" class="placeholder" disabled="">{{trans('public.choose_country')}}
                                            </option>
                                            @foreach ($countries as $country)
                                                <option value="{{ $country }}"
                                            ...
                                            <option value="اخرى"
                                                ...
                                                id="anotherEducationCountryOption2">{{trans('public.other')}}</option>
                                        </select>
                                    ...
                                    <div class="form-group col-12 col-sm-6">
                                        ...
                                        <input type="text" id="educational_area"
                                            ...
                                            name="educational_area" placeholder="{{trans('public.education_region')}}"
                                    ...
                                    <div class="form-group col-12 col-sm-6 secondary_education">
                                        <label for="secondary_graduation_year" class="form-label">
                                            {{ trans('public.secondary_certificate_year') }}<span class="text-danger">*</span>
                                        </label>
