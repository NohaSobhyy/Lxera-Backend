    ...
    <section class="row mt-20 container">
        <section class="main-container border border-2 border-secondary-subtle rounded p-3 mt-2 mb-25 row mx-0">
            ...
            <div class="form-group col-12 col-sm-6">
                ...
                <select id="nationality" name="nationality" required
                    ...
                    <option value="" class="placeholder" disabled>
                        {{trans('public.nationality_choose')}}</option>
            ...
            <div class="form-group col-12 col-sm-6" id="other_nationality_section" style="display: none">
                <label for="nationality">{{trans('public.enter_nationality')}}<span class="text-danger">*</span></label>
                <input type="text" class="form-control @error('nationality') is-invalid @enderror"
                    id="other_nationality" name="" placeholder="{{trans('public.enter_nationality')}}" {{-- value="{{ $student ? $student->other_nationality : '' }}" --}}
            ...
            <div class="form-group col-12 col-sm-6">
                ...
                <select id="mySelect" name="country" required
                    ...
                    <option value="" class="placeholder" disabled="">{{ trans('public.enter_your_country') }}</option>
            ...
            <div class="form-group col-12 col-sm-6" id="anotherCountrySection" style="display: none">
                <label for="city" class="form-label">{{trans('public.enter_country')}}<span class="text-danger">*</span></label>
                <input type="text" id="city" name="city"
                    class="form-control  @error('city') is-invalid @enderror" placeholder="{{trans('public.enter_your_country')}}"
            ...
            <div class="form-group col-12 col-sm-6" id="region" style="display: none">
                <label for="area" class="form-label">{{ trans('public.region') }}<span class="text-danger">*</span></label>
                <input type="text" id="area" name="area"
                    class="form-control  @error('area') is-invalid @enderror" placeholder="{{ trans('public.region') }}"
            ...
            <div class="form-group col-12 col-sm-6">
                <div id="cityContainer">
                    <label for="town" id="cityLabel">{{ trans('application_form.city') }}<span
                            class="text-danger">*</span></label>
                    <input type="text" id="town" name="town" placeholder="{{ trans('application_form.city') }}"
