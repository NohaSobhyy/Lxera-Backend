<section class="mt-30">
    <div class="d-flex justify-content-between align-items-center mb-10">
        <h2 class="section-title after-line">{{ trans('public.work_links') }}</h2>
        <button id="userAddLinks" type="button" class="btn btn-primary btn-sm">{{trans('public.add_link')}}</button>
    </div>
                        ...
                        <div class="link-card py-15 py-lg-30 px-10 px-lg-25 rounded-sm panel-shadow bg-white d-flex align-items-center justify-content-between">
                            <div class="col-10 text-secondary font-weight-500 text-left link-value" link-value="{{ $link->value }}" >
                                ...
                                <div class="row">
                                    ...
                                    <p class="col-12 col-sm-6">
                                        {{trans('public.years_of_experience')}} {{ $matches[2] }} 1
                                    </p>
                                </div>
...
<div class="d-none" id="newLinkModal">
    ...
    <div class="mt-20 text-center">
        ...
        <h4 class="font-16 mt-20 text-dark-blue font-weight-bold">{{trans('public.add_link_in_one_line')}}</h4>
