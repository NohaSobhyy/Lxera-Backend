                    ...
                    <div class="row mt-30">
                        <div class="col-12">
                            ...
                            <div class="panel-section-card py-20 px-25 mt-20">
                                <h3 class="font-16 text-dark-blue font-weight-bold mb-20">{{trans('panel.program_fee_installment_schedule')}}</h3>
                                                    ...
                                                    @if (!empty($order->selectedInstallment->upfront))
                                                        ...
                                                        <tr>
                                                            <td class="">
                                                                ...
                                                                <span class="text-center"> ({{trans('panel.for_registration')}})</span>
