...
<div class="panel-sidebar pt-50 pb-25 px-25" id="panelSidebar" style="overflow: auto">
    ...
    <div class="user-info d-flex align-items-center flex-row flex-lg-column justify-content-lg-center">
        <a href="/panel" class="user-avatar bg-gray200">
            <img src="{{ asset('assets/default/img/ANASAcademylogo.png') }}" class="img-cover" alt="{{ $authUser->full_name }}">
        </a>
        ...
        @can('show_panel')
            <li class="sidenav-item {{ request()->is('panel') ? 'sidenav-item-active' : '' }}">
                <a href="/panel" class="d-flex align-items-center">
                    ...
                    <span class="font-14 text-dark-blue font-weight-500"> {{ trans('panel.main_menu') }} </span>
                </a>
            </li>
        @endcan
        {{-- requirements link --}}
        @if (auth()->user()->Student)
            <li
                ...
                <a class="d-flex align-items-center" data-toggle="collapse" href="#requirementsCollapse" role="button"
                    ...
                    <span class="font-14 text-dark-blue font-weight-500"> {{ trans('panel.acpt_rgst') }} </span>
                </a>
                    ...
                    <ul class="sidenav-item-collapse">
                        @if (count(auth()->user()->getAllPurchasedWebinarsIds()) > 0 || count(auth()->user()->webinarOfflinePayments) > 0)
                            <li class="mt-5 {{ request()->is('panel/courses/applied') ? 'active' : '' }}">
                                <a href="/panel/courses/applied"> {{ trans('panel.courses_pay') }}
                                </a>
                            </li>
                        @endif
                        ...
                        <li class="mt-5 {{ request()->is('panel/newEnrollment') ? 'active' : '' }}">
                            <a href="/panel/newEnrollment"> {{ trans('panel.new_rgstr') }} </a>
                        </li>
                        <li class="mt-5 ">
                            <a href="/professionalCourses">
                                {{ trans('panel.new_prof_course') }}
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        @can('student_showClasses')
            <li
                ...
                <a class="d-flex align-items-center" data-toggle="collapse" href="#webinarCollapse" role="button"
                    ...
                    @if ($authUser->isUser())
                        <span class="font-14 text-dark-blue font-weight-500"> {{ trans('panel.moqarrat') }}  </span>
                    @else
                        <span class="font-14 text-dark-blue font-weight-500">
                            {{ trans('panel.edu_courses') }}    
                        </span>
                    @endif
                </a>
                        ...
                        @if (getInstallmentsSettings('status'))
                            @if (\App\Models\InstallmentOrder::query()->where('user_id', auth()->user()->id)->where('status', '!=', 'paying')->exists())
                                <li
                                    ...
                                    <a href="/panel/financial/installments">{{ trans('panel.program_installments') }}</a>
                                </li>
                            @endif
                        @endif
                        @php
        ...
        @can('show_support')
            <li
                ...
                <a class="d-flex align-items-center" data-toggle="collapse" href="#supportCollapse" role="button"
                    ...
                    <span class="font-14 text-dark-blue font-weight-500">{{trans('panel.support_and_communication_team')}}</span>
                </a>
        ...
        @can('users_services')
            <li class="sidenav-item {{ request()->is('panel/service*') ? 'sidenav-item-active' : '' }}">
                <a class="d-flex align-items-center" data-toggle="collapse" href="#servicesCollapse" role="button"
                    ...
                    <span class="font-14 text-dark-blue font-weight-500"> {{  trans('panel.srvcs') }} </span>
                </a>
                    ...
                    <ul class="sidenav-item-collapse">
                        @can('users_services_list')
                            <li class="{{ request()->is('panel/services', false) ? 'active' : '' }}">
                                <a class="nav-link" href="/panel/services">{{ trans('panel.simple_menu') }}</a>
                            </li>
