    ...
    <div class="row_cal">
        <div class="col_cal">
            <div class="d-flex_cal justify-content-between_cal">
                <button class="btn btn-primary" id="prev-month"> {{ trans('panel.clndr_prv_month') }} </button>
                <button class="btn btn-primary" id="next-month">  {{ trans('panel.clndr_nxt_month') }} </button>
            </div>
