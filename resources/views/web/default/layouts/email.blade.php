                            ...
                            <table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
                                <tr>
                                    ...
                                    <table class="message" width="100%" border="0" cellspacing="0"
                                        cellpadding="0" style="direction: rtl !important; text-align: right; background-color: #0e0e0e;">
                                        <tr>
                                                        ...
                                                        <tr style="display: flex; padding:10px;">
                                                            ...
                                                            <td class="img d"
                                                                ...
                                                                width="50%"><a
                                                                    ...
                                                                    target="_blank"
                                                                    style="color: #4e54cb; text-decoration: none;"><img
                                                                        src="https://anasacademy.uk/old/wp-content/uploads/2021/10/Layer-1-1.png"
                                                                        width="30" height="30"
                                                                        mc:edit="image_15"
                                                                        style="-ms-interpolation-mode: bicubic; max-width: 40px; margin: 0 5px !important;"
                                                                        border="0" alt=""></a><a
