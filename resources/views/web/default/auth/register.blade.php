...
<style>
  ...
  overflow-y: auto;
    ...
    @endphp
    <div class="p-3 p-lg-5 m-md-3 col-sm-7 col-md-8 col-lg-3 border-radius-lg border shadow paddingy-none bg-white">
        <div class="col-6 col-md-6 p-0 mb-4 mt-3 mt-md-auto mx-auto d-flex flex-column align-items-center">
        ...
        <form method="post" action="/register" class="mt-35" id="registerForm">
            ...
            {{-- <div class="form-group">
                ...
                <input name="full_name" type="text" value="{{ old('full_name') }}" required
                    class="form-control @error('full_name') is-invalid @enderror" placeholder="أدخل الأسم الثلاثي باللغة العربية ">
                @error('full_name')
            ...
            <div class="form-group">
                ...
                <input name="en_name" type="text" value="{{ old('en_name') }}" required
                    class="form-control @error('en_name') is-invalid @enderror" placeholder="أدخل الأسم الثلاثي باللغة الإنجليزية ">
                @error('en_name')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group">
                <label class="form-label">حدد نوع البرنامج المطلوب<span class="text-danger">*</span></label>
            ...
            <div class="form-group  d-none">
                <label class="form-label"> اختر نوع البرنامج الدراسي <span class="text-danger">*</span></label>
            ...
            <div class="form-group  d-none">
                <label class="form-label">اختر نوع البرنامج الدراسي الذي ترغب بالالتحاق فيه<span class="text-danger">*</span></label>
                <select id="bundleSelect" name="bundle_id" class="form-control @error('bundle_id') is-invalid @enderror"
                    ...
                    <option selected hidden value="">اختر  نوع البرنامج الذي تريد دراسته في
                        اكاديمية انس للفنون </option>
            ...
            {{-- <div class="form-group">
                <label class="input-label" for="google-signup"></label>
        ...
        <div class="ft-text text-center mt-20 mb-35 registertext">
