                                ...
                                <div class="d-flex align-items-center">
                                    <figure class="avatar mr-2">
                                        <img src="{{ $enrollment->buyer?->getAvatar() }}"
                                            alt="{{ $enrollment->buyer?->en_name ? $enrollment->buyer?->en_name : $enrollment->buyer?->full_name }}">
                                    </figure>
                                    <div class="media-body ml-1">
                                        <div class="mt-0 mb-1 font-weight-bold">
                                            {{ $enrollment->buyer?->en_name ? $enrollment->buyer?->en_name : $enrollment->buyer?->full_name }}
                                        </div>
