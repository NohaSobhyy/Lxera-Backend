<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <div class="sidebar-search">
            <input type="text" id="menu-search" class="form-control" placeholder="{{ trans('admin/main.search') }}" />
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            @can('admin_user_access')
                <ul>
                    <li class="{{ request()->is(getAdminPanelUrl('/user_access', false)) ? 'active' : '' }}">
                        <a class="nav-link @if (!empty($sidebarBeeps['requirements']) and $sidebarBeeps['requirements']) beep beep-sidebar @endif"
                            href="{{ getAdminPanelUrl() }}/user_access">
                            <i class="fas fa-graduation-cap"></i>
                            صلاحيه الطلاب</a>
                    </li>
                </ul>
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_bundle_transform_list')
                            ...
                            <li class="{{ request()->is(getAdminPanelUrl('/financial/bundle_transforms', false)) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/financial/bundle_transforms">{{trans('admin/main.requests_list')}}</a>
                ...
                <li
                    ...
                    <ul class="dropdown-menu">
                        @can('admin_webinars_list')
                            ...
                            <li
                                class="{{ (request()->is(getAdminPanelUrl('/webinars', false)) and request()->get('type') == 'newGraduation_project') ? 'active' : '' }} p-1">
                                <a class="nav-link " href="{{ getAdminPanelUrl() }}/webinars?type=newGraduation_project">مشاريع التقيم النهائي</a>
                            </li>
                        @endcan()
                    ...
                    <ul class="dropdown-menu">
                        @can('admin__purchased_certificate_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/certificates', false)) ? 'active' : '' }}">
                                <a class="nav-link" href="{{ getAdminPanelUrl() }}/certificates/purchase">
                                    الشهادات
                                    المعتمدة
                                </a>
                            </li>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        searchInput.addEventListener('input', function() {
            ...
            menuItems.forEach(item => {
                ...
                if (matches) {
                    item.style.display = '';
                    const nestedMenus = item.querySelectorAll('ul');
                    nestedMenus.forEach(ul => ul.style.display = '');
                } else {
