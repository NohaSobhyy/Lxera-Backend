                        ...
                        <table class="table table-striped font-14">
                            ...
                            @foreach ($supports as $support)
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <a title="{{ optional($support->user)->full_name }}" 
                                            href="{{ optional($support->user)->getProfileUrl() }}" 
                                            target="_blank">
                                            {{ optional($support->user)->full_name }}
                                         </a>

                                    </td>

                                    <td class="text-center">
                                        @if ( optional($support->user)->isUser())
                                            Student
                                        @elseif(optional($support->user)->isTeacher())
                                            Teacher
                                        @elseif(optional($support->user)->isOrganization())
                                            Organization
                                        @endif
                                    </td>
