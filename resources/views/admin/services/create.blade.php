...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ !empty($service) ? trans('/admin/main.edit') : trans('admin/main.new') }} 
                {{ trans('admin/main.electronic_service') }}
            </h1>
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active">
                    <a href="{{ getAdminPanelUrl() }}/services">{{ trans('admin/main.electronic_services') }}</a>
                </div>
                                        ...
                                        <div class="col-12 col-md-7">
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <input type="text" name="title"
                                                    ...
                                                    placeholder="{{ trans('admin/main.enter_service_title') }}" />
                                                @error('title')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="form-group mt-15">
                                                ...
                                                <textarea rows="5" name="description" class="form-control @error('description')  is-invalid @enderror"
                                                    placeholder="{{ trans('admin/main.enter_service_description') }}">{{ !empty($service) ? $service->description : old('description') }}</textarea>
                                                @error('description')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label"
                                                    for="targetSelect">{{ trans('admin/main.service_goal') }}
                                                    <span class="text-danger">*</span>
                                                </label>
                                            ...
                                            <div class="form-group" id="bundleDropdown" style="display: none;">
                                                <label class="control-label">{{ trans('admin/main.programs') }}
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <select name="bundles[]" id="bundles"
                                                    class="form-control select2 @error('bundles')  is-invalid @enderror"
                                                    data-placeholder= '{{ trans('admin/main.select_programs') }}' multiple>
                                            ...
                                            <div class="form-group" id="webinarDropdown" style="display: none;">
                                                <label class="control-label"> {{ trans('admin/main.courses') }}
                                                    <span class="text-danger">*</span>
                                                </label>
                                                <select name="courses[]" id="courses"
                                                    class="form-control select2 @error('courses')  is-invalid @enderror"
                                                    data-placeholder= '{{ trans('admin/main.select_courses') }}' multiple>
                                            ...
                                            @if (isset($service))
                                                <div class="form-group mt-15">
                                                    <label class="input-label">{{ trans('admin/main.application_url') }}
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    ...
                                                    <div class="text-muted text-small mt-1">
                                                        {{ trans('admin/main.service_application_url') }}
                                                    </div>
                                                    @error('apply_link')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
                                                ...
                                                <div class="form-group mt-15">
                                                    <label class="input-label">
                                                        {{ trans('admin/main.previous_request_url') }}
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <input type="url" name="review_link"
                                                        ...
                                                        placeholder="" />
                                                    <div class="text-muted text-small mt-1">
                                                        {{ trans('admin/main.previous_service_request_url') }}
                                                    </div>
                                                    @error('review_link')
                                                        <div class="invalid-feedback">
                                                            {{ $message }}
