    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="row">
                ...
                <a href="{{ getAdminPanelUrl() }}/services/requests/{{ $service->id }}/export" class="btn btn-primary">
                    <i class="fa fa-download"></i> تصدير إلى Excel
                  </a>
               </div>
                            <div class="table-responsive">
                                <table class="table table-striped font-14 ">
                                    <tr>
                                        ...
                                        <th class="text-center">{{ trans('admin/main.student_code') }}</th>
                                        <th class="text-center">{{ trans('admin/main.student_name') }}</th>
