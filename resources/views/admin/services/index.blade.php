...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>{{ trans('admin/main.electronic_services_list') }}</h1>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped font-14 ">
                                    <tr>
                                        ...
                                        <th class="text-center">{{ trans('admin/main.price_sar') }}</th>
                                        <th class="text-center">{{ trans('admin/main.status') }}</th>
                                        <th class="text-center">{{ trans('admin/main.creator') }}</th>
                                        <th class="text-center">{{ trans('admin/main.creation_date') }}</th>
                                    ...
                                    @foreach ($services as $service)
                                        <tr class="text-center">
                                            ...
                                            <td class="text-center @if ($service->status == 'inactive') text-danger @endif">
                                                {{ trans('admin/main.' . $service->status) }}</td>
