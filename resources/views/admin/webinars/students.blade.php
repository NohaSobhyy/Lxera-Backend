...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            @endcan
            <div class="breadcrumb-item mr-2">
        <a href="{{ getAdminPanelUrl() }}/webinars/{{ $webinar->id }}/students/export" class="btn btn-primary">
            <i class="fa fa-download"></i> استخراج فى الاكسل
        </a>
    </div>
            <div class="h-10"></div>
        </div>
