                    ...
                    @foreach ($bundlstudents as $index => $bundlstudent)
                        <tr>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="media-body ml-1">
                                        <div class="mt-0 mb-1 font-weight-bold">
                                            {{  $bundlstudent->student->ar_name ?? $bundlstudent->student->registeredUser->full_name  ?? ''}}</div>
                            ...
                            <td>
                                ...
                                @else
                                <div class="mt-0 mb-1 font-weight-bold {{ optional($bundlstudent->student->registeredUser)->status == 'active' ? 'text-success' : 'text-warning' }}">
                                    {{ trans('admin/main.' . optional($bundlstudent->student->registeredUser)->status) }}
                                </div>
                                @endif
                            </td>
