                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            @include('admin.students.includes.importStudents', [
                                ...
                                'btnText' => '<span class="ml-2">' . trans('admin/main.upload_students_from_excel') . '</span>',
                            ...
                            <a href="{{ getAdminPanelUrl() }}/webinars/courseCodeExcel" class="btn btn-info mr-3">
                                {{ trans('admin/main.download_course_codes') }}
                            </a>
                        </div>
