                                ...
                                <section>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-5">
                                            ...
                                            <div class="form-group mt-15" id="courseDropdown">
                                                <label class="control-label">دورات الشهادات الاحترافيه</label>
                                                <select name="course_id[]" id="course_id" class="form-control select2" multiple data-placeholder="قم بتحديد الدورات">
                                                    <option value="">-- Select course --</option>
                                                    @foreach ($webinars as $webinar)
                                                        <option value="{{ $webinar->id }}"
                                                            @if (in_array($webinar->id, old('course_id', [])) || (!empty($bundle) && $bundle->bundleProfessionalWebinars->contains($webinar->id))) selected @endif>
                                                            {{ $webinar->slug }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div  class="form-group mt-15">
                                                <label class="input-label">رفع الدليل الاكاديمي</label>
                                                <input type="file" name="academic_guide"
                                                    value="{{ !empty($bundle) ? $bundle->academic_guide : old('academic_guide') }}"
                                                    class="form-control @error('academic_guide') is-invalid @enderror" />
                                                @error('academic_guide')
                                                    <div class="invalid-feedback d-block">
                                                        {{ $message }}
                                                    </div>
                                                @enderror
