                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif($template->type == 'attendance')
                                                 ...
                                                 @elseif($template->type == 'new_verssion_bundle')
                                                    <span class="">new verssion bundle</span>
                                                @elseif($template->type == 'new_verssion_course')
                                                    <span class="">new verssion course</span>
                                                @elseif($template->type == 'new_verssion_attendance')
                                                    <span class="">new verssion attendance</span>
                                                @else
