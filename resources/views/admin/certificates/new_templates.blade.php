                    ...
                    <form method="post" action="" id="templateForm" class="form-horizontal form-bordered">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                    ...
                                    <select id="typeSelect" name="type"
                                        ...
                                        <option value="bundle"
                                            ...
                                            {{ (!empty($template) and $template->type == 'attendance') ? 'selected' : '' }}>
                                               شهاده حضور</option>   
                                               <option value="new_verssion_bundle"
                                               {{ (!empty($template) and $template->type == 'new_verssion_bundle') ? 'selected' : '' }}>
                                               new verssion bundle</option> 
                                               <option value="new_verssion_course"
                                               {{ (!empty($template) and $template->type == 'new_verssion_course') ? 'selected' : '' }}>
                                               new verssion course</option> 
                                               <option value="new_verssion_attendance"
                                               {{ (!empty($template) and $template->type == 'new_verssion_attendance') ? 'selected' : '' }}>
                                               new verssion attendance</option> 
                                    </select>
                                    <div class="invalid-feedback">
                                        @error('type')
                                            {{ $message }}
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="student_name">{{ trans('admin/main.student_name') }}</label>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function handleTypeChange() {
        ...
        else if (selectedType === 'new_verssion_bundle') {
            bundleDropdown.style.display = 'block';
            courseDropdown.style.display = 'none';
        }
        else if (selectedType === 'new_verssion_course') {
            bundleDropdown.style.display = 'none';
            courseDropdown.style.display = 'block';
        }else if (selectedType === 'new_verssion_attendance') {
            bundleDropdown.style.display = 'block';
            courseDropdown.style.display = 'none';
        }
        else {
