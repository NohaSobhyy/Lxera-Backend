...
Route::group(['prefix' => $prefix, 'namespace' => 'Admin', 'middleware' => ['web',  'admin_locale']], function () use ($prefix) {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'classes'], function () {
            Route::get('/', 'StudyClassController@index')->name('admin.study_classes.lists');
            //  Route::delete('/{batchId}/delete_students', 'StudyClassController@deleteUserFoldersForClass')->name('deleteUserFoldersForClass');
            Route::post('/delete-user-folders', 'StudyClassController@deleteUserFoldersForClass')->name('deleteUserFoldersForClass');
        ...
        Route::group(['prefix' => 'webinars'], function () {
            ...
            Route::get('/{id}/students/export', 'WebinarController@exportStudents')->name('webinars.students.export');
        ...
        Route::group(['prefix' => 'services'], function () {
            ...
            Route::get('/requests/{service}/export', 'ServiceController@exportRequests')->name('services.requests.export');
        ...
        Route::group(['prefix' => 'certificates'], function () {
            Route::put('/{certificate}/updateGraduationDate', 'CertificateController@updateGraduationDate')
                ->name('admin.certificate.update_graduation_date');
            ...
            Route::delete('/delete-selected', 'CertificateController@deleteSelected')->name('admin.certificates.deleteSelected');
        ...
        Route::get('/user_access', 'SaleController@index2');
        Route::group(['prefix' => 'financial'], function () {

            Route::group(['prefix' => 'sales'], function () {
                Route::get('/', 'SaleController@index');

                Route::post('/{sale}/toggle-access', 'SaleController@toggleAccess');
